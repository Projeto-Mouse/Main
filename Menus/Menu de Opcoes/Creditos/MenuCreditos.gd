...
var credits_data = [
	{
		...
		"roles": [
			...
			{"role": "CREDITS_PRODUCERS", "names": ["Matheus Araujo Pinheiro", "Pedro Henrique Gonçalves de Paula", "Wesley Heringer de Brito", "Vinicius"]},
	...
	},
	{
		...
		"roles": [
			...
			{"role": "CREDITS_CO_WRITERS", "names": ["Matheus Araujo Pinheiro", "Pedro Henrique Gonçalves de Paula", "Vinicius"]}
		]
	},
	{
	...
	},
	{
		...
		"roles": [
			...
			{"role": "CREDITS_3D_MODELING", "names": ["Matheus Araujo Pinheiro", "Wesley Heringer de Brito"]},
			{"role": "CREDITS_TEXTURE_VFX", "names": ["Matheus Araujo Pinheiro", "Wesley Heringer de Brito"]},
